# Elara Moonweaver — High Elf Wizard
...
**Character Name:** Elara Moonweaver
...
**Armor Class AC:** 14 (mage armor, Dex)
**Hit Points HP:** 32
**Speed:** 30 ft/6 tiles
**Proficiency Bonus:** +3
...
- **Arcane Recovery** — Recover spell slots totaling half wizard level (rounded up) on a short rest, once per day.
- **Ritual Casting** — Cast prepared rituals without spending a slot (adds 10 minutes).
