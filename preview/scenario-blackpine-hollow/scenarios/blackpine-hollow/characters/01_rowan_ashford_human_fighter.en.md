...
|---|---|---|---|
| Longsword | +5 | 1d8+3 slashing | One-handed, use with shield |
| Longsword | +5 | 1d10+3 slashing | Two-handed, no shield bonus |
...
- **Protection Instinct** — Rowan naturally steps between danger and weaker allies.
...
**Gear**
- Traveler's clothes
- Bedroll, mess kit, tinderbox, rope, rations
