...
| blackpine-hollow | `scenario/blackpine-hollow` | Yes | Camping one-shot, level 3 (homebrew) |
| when-the-lanterns-fall-silent | `scenario/when-the-lanterns-fall-silent` | Yes | Homebrew campaign |
